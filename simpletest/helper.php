...
/**
 * Test helpers for the transcription question type.
 *
 * @package    qtype_transcription
...
/**
 * Test helper class for the transcription question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_transcription_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a transcription question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_transcription_question
     */
    public function make_transcription_question_frogtoad() {
        ...
        $sa->name = 'Transcription question';
    ...
    /**
     * Gets the question data for a transcription question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_transcription_question_data_frogtoad() {
        $qdata = new stdClass();
     ...
     * @return qtype_transcription_question
     */
    public function make_transcription_question_frogonly() {
        question_bank::load_question_definition_classes('transcription');
        $sa = new qtype_transcription_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Transcription question';
